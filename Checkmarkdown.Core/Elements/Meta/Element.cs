...
public abstract class Element {
    ...
    /// <param name="found">When <c>true</c>, indicates that text-containing descendant has been found
    /// and the title must be constructed from it and its siblings.</param>
    /// <returns></returns>
